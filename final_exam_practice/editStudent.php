                ...
                <div class="card-body">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="form-group">
                            <input type="hidden" name="student-id" required value="<?php echo $value['stu_id']; ?>">
                        </div>
                        <!-- input username -->
                        <div class="form-group">
                            <input type="text" name="student-name" class="form-control" placeholder="Name" required value="<?php echo $value['stu_name']; ?>">
                        </div>
                        <!-- input email -->
                        <div class="form-group">
                            <input type="email" name="student-email" class="form-control" placeholder="Email" required value="<?php echo $value['stu_email'];  ?>">
                        </div>
                    <?php if($value['stu_gender'] == "Male"){ ?>
                        <!-- input gender -->
                    ...
                    <?php }; ?>
                        ...
                        <br>
                         <!-- input age  -->
                         <div class="form-group">
                            <input type="number" name="student-age" class="form-control" placeholder="Age" required value="<?php echo $value['stu_age'] ?>">
                        </div>
