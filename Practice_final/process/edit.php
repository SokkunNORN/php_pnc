           ...
           ?>
               <form action="#" method="POST">
                   <div class="input-field">
                       ...
                       <input type="text" name="name" id="text-name" value="<?php echo $value['username']; ?>" 
                   ...
                   <?php } ?>
                    <div class="input-field">
                        ...
                        <textarea name="message" id="sms"
                        class="materialize-textarea" required><?php echo $value['user_message']; ?></textarea>
                    ...
                    <button class="btn right" type="submit" name="btn-update">
